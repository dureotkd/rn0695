  ...
  return (
    <PagerView orientation="vertical" style={{ flex: 1 }}>
      <View key="1" style={{ flex: 1, paddingVertical: 8, paddingHorizontal: 14, position: 'relative' }}>
        <View style={{ borderRadius: 6, backgroundColor: COLORS.grey600, flex: 0.65, justifyContent: 'center', alignItems: 'center' }}>
          <Icon name="lightning-bolt" size={100} color={COLORS.black} />
        </View>
        <View style={{ flex: 0.35, marginTop: MARGIN.xxxl, paddingLeft: 12 }}>
          <View style={{ flex: 0.6 }}>
        ...
        <TouchableOpacity activeOpacity={0.7} style={[styles.bottomButton]}>
          <Text style={{ color: '#fff', fontSize: FONT_SIZE.xl, fontWeight: '600' }}>자동매칭</Text>
        </TouchableOpacity>
      </View>
